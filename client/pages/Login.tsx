...
export default function Login() {
    const { isAuthenticated, isLoading, signInWithGoogle, signInWithEmail, registerWithEmail } = useAuth();
                ...
                <div className="glass-card rounded-2xl p-8 animate-scale-in">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex justify-center">
                            <Button type="button" variant="secondary" className="h-12 rounded-full px-8 font-semibold" onClick={signInWithGoogle}>
